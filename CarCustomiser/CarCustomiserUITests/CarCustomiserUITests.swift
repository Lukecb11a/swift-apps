...
class CarCustomiserUITests: XCTestCase {
    ...
    func testWhenEngineAndTyresPackagesAreEnabledGoFasterAndVandalismPackagesAreDisabled() {
        ...
        XCTAssertEqual(app.switches["goFasterSwitch"].isEnabled, false)
        XCTAssertEqual(app.switches["vandalismSwitch"].isEnabled, false)
